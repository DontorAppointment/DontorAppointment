<?php include('header.php'); ?>
	...
	<div class="doctors">
		                    ...
		                    <h3 class="text-center" style="background-color:#0616BC;color: #fff;">Doctors In Our Hospital</h3>
                            <div class="col-md-12" style="">
                                  


                                  <div class="col-md-3">
                                      <img src="img/doctor1.png" alt="" class="img-responsive" style="width: 220px;height: 220px">
                                  </div> <br>

                                  <div class="col-md-3" > 

                                     
                                     <h3 style="color:#0616BC;">Dr. Alfed Kaza JACKSON</h3>
                                 ...
                                 <div class="col-md-3">
                                      <img src="img/43592363897da6b11ac5o-black-doctor-png-378_432.jpg" alt="" class="img-responsive" style="width: 220px;height: 220px"> <br>
                                  </div>

                                  <div class="col-md-3">
                                       
                                       <h3 style="color:#0616BC;">Dr. ELISA MABENA</h3>
...
Gynecologist & Obestetrics
                            ...
                            <br><br>
                             ...
                             <div class="col-md-12" style="">
                                  ...
                                  <div class="col-md-3">
                                      <img src="img/doctor4.png" alt="" class="img-responsive" style="width: 220px;height: 220px">
                                  </div>

                                  <div class="col-md-3" > 

                                     
                                     <h3 style="color:#0616BC;">Dr. Mpho Masuku</h3>
...
Expertise: Brain, Nerve & Spine, Neuro-Surgeon
                                 ...
                                 <div class="col-md-3">
                                      <img src="img/doctor_PNG15994.png" alt="" class="img-responsive" style="width: 220px;height: 220px">
                                  </div>

                                  <div class="col-md-3">
                                       
                                       <h3 style="color:#0616BC;">Dr. John Jack Maddog</h3>
