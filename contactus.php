	...
	<div class="contactus"  style="background-color:#fff;">
		...
		<div class="main_content">
			<div class="col-md-6" style="border-right: 2px solid black;">
				<article>
					<h2>For Life Hospital <h2><h4>Situated in Gauteng #Tshwane</h4>
						<p> https://www.ForLifeHospital.com <br>
							https://linkedin.com/in/ForLifeHospital<br>
							https://facebook/ForLifeHospital <br>
							cell: +271 2471 9639</p><br>
				</article>
			</div>
			<div class="col-md-6">
